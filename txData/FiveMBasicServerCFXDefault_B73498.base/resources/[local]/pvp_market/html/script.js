    ...
    catalogData.forEach(w => {
        html += `
            <div class="weapon-card">
                <img src="https://cfx-nui-images/Weapons/${w.name.replace(/ /g, '%20')}.png" class="w-icon" style="object-fit: contain;" alt="${w.name}" onerror="this.onerror=null; this.style.display='none';">
