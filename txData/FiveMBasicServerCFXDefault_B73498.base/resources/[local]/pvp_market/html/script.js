    ...
    catalogData.forEach(w => {
        html += `
            <div class="weapon-card">
                <img src="nui://pvp_inv/html/img/Weapons/${w.name}.png" class="w-icon" style="object-fit: contain;" alt="${w.name}" onerror="this.onerror=null; this.outerHTML='<div class=\\'w-icon\\'>&#128299;</div>'">
